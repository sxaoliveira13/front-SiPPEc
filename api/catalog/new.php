...
try {
    $sql = "INSERT INTO catalogo (userId, CategoriaId, Titulo, Status, AguardandoRevisao, PublicoAlvoId, Conteudo, FerramentaId, HabilidadeId, Ambiente, Abordagem, CaminhoDeAcesso) VALUES (:userId, :categoria, :titulo, :status, :aguardandoRevisao, :publico, :conteudo, :ferramenta, :habilidade, :ambiente, :abordagem, :link)";
