                ...
                <div class="auth-card__body">
                    <form id="loginForm" class="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="position-relative">
                                <input class="form-group__input form-group__input--line" type="password" placeholder="Informe a senha de acesso" id="userPassword" name="userPassword" required autocomplete="off">
                    ...
                    <a href="#" class="d-block text-end text-link my-4">Esqueci minha senha</a>
