...
<script src="<?php echo $CFG['system_url'] ?>js/login.js"></script>
</head>
...
<body>
    ...
    <main class="main u-container u-flex-auto">
        <section class="main__section">
            <div id="authBox" class="card auth-card">
                ...
                <div class="auth-card__body">
                    <form id="loginForm" class="form">
                        <div class="form-group">
                            ...
                            <div class="position-relative">
                                <input class="form-group__input form-group__input--line" type="email" placeholder="Informe o email de acesso" id="userEmail" name="userEmail" required maxlength="128" rautocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="position-relative">
                                ...
                                <div onclick="togglePasswordVisibility(this)">
                    ...
                    <a href="#" class="d-block text-end text-link my-4" onclick="forgotMyPassword()">Esqueci minha senha</a>
                    <a id="btnSubmitLogin" href="#" class="button-primary mt-5">Acessar Conta</a>
                    <a href="register.php" class="button-dark mt-3">Criar Conta</a>
                </div>
            </div>
            <div id="recoverPasswordBox" class="card auth-card d-none">
                <div class="auth-card__header">
                    <div class="auth-card__header-img">
                        <img src="assets/img/act.png" class="img-fluid" alt="LIAG">
                    </div>
                ...
                <div class="auth-card__body">
                    <form id="recoverPasswordForm" class="form">
                        <div class="form-group">
                            <label class="form-group__label" for="userRecoverEmail">Email <span class="text-danger">*</span></label>
                            <div class="position-relative">
                                <input class="form-group__input form-group__input--line" type="email" placeholder="Informe o email de acesso" id="userRecoverEmail" name="userRecoverEmail" required maxlength="128" rautocomplete="off">
                            </div>
                        </div>
                    </form>
