                ...
                <div class="auth-card__body">
                    <form id="registerForm" class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-group__input form-group__input--line phoneMask" type="text" placeholder="Informe o seu telefone de contatto" id="userPhone" name="userPhone" required maxlength="20" autocomplete="off">
                        </div>
                        <div class="form-group">
                    ...
                    <a href="#" class="button-primary mt-5">Criar Conta</a>
